...
class View extends JFrame
{
    ...
    int W = 1000;         // Width  of window pixels
    ...
    public void start(Stage window)
    {
        ...
        // Creating the user interface component objects
        ...
        // the css file
        String labels[][] = {
                {"7",    "8",  "9",  "",  "Withdraw",  "Deposit"},
                {"4",    "5",  "6",  "",  "Balance",  "Statement"},
                {"1",    "2",  "3",  "",  "Change PIN",  "Log Out"},
                {"CLR",  "0",  "",   "",  "Admin",  "Enter"},
                {"",  "",  "",   "",  "",  ""}
        };

        // looping through the array, making a Button object for each label
